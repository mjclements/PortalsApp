...
import com.example.mjclements.myapplication.PortalsHome;

/**
 * A login screen that offers login via email/password.
 */
public class LoginActivity extends welcome_screen {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mEmailSignInButton.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                try {
                    // access the database to authenticate user.
                    String email = mEmailView.getText().toString();
                    String password = mPasswordView.getText().toString();
                    DataStorageWrapper db = new DataStorageWrapper(getApplicationContext());
                    User login = db.basic_authenticate(email, password);
                    uuID = login.getID().toString();
                ...
                if (go) {
                    Intent k = new Intent(LoginActivity.this, PortalsHome.class);
                    //k.putExtra("email", email444);

                    // 3. or you can add data to a bundle
                    Bundle extras = new Bundle();
                    extras.putString("status", uuID );
